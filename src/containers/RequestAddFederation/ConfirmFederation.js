...
class ConfirmFederation extends Component {
    state = {
        loading: false,
        coopId: "",
        accountCategory: "",
    ...
    loadFedUnion = async () => {
        ...
        if (id !== "") {
            try {
                const res = await axios.get(`${API_URL}/unionfed/fed/${id}`);
    ...
    updateunionstatus = async (union_fed_id, decision) => {
        if (union_fed_id !== null || union_fed_id !== undefined || union_fed_id !== "") {
            this.setState({ loading: true });
            try {
                ...
                
                {
                    ...
                    <div className="row">
                        ...
                        <div className="col xl10 l19 m10 s12">
                            <h5><b className="title-txt">List of my unions</b></h5>
                        </div>
                    </div>
                    ...
                    <hr/>
                    <div>
                        {console.log("New coops:", this.state.unions)}
                        <table>
                            <thead>
                            <tr>
                                <th>#</th>
                                            ...
                                            <tr key={i + 1}>
                                                ...
                                                <td>
                                                    <div className="table-icons">
                                                        ...
                                                        <AiFillCheckCircle onClick={() => this.updateunionstatus(item.union_fed_id, 1)} className="table-icons-icon-success" />
                                                        <AiFillCloseCircle onClick={() => this.updateunionstatus(item.union_fed_id, 2)} className="table-icons-icon-danger" />
                                                    </div>
                                                </td>
                                            </tr>
                                        )}})
