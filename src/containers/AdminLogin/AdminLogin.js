            ...
            <div className="col xl4 l4 m6 s12">
              <div className="login-container admin-login animate__animated animate__zoomIn">
                <Link to="/" style={{ height: "30px" }}>
                  <IoMdArrowRoundBack className="left regist-bars" />{" "}
                  <div
                    style={{
                      width: "fill-content",
                      paddingTop: "7px",
                ...
                <form onSubmit={this.LoginUser}>
                  <h1 className="center-align" style={{ margin: "0px" }}>
                    <AiOutlineUser className="login-icon" />
                  </h1>

                  <div className="center-align">
                    <div className="my-title" style={{ marginBottom: "0px" }}>
                      Administrator
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="input-field col s12">
                      <input
                        ...
                        placeholder="Email"
                        type="text"
                        className={`validate browser-default my-input ${
                      ...
                      />
                      {this.state.error.element === "username" ? (
                        <span className="helper-text danger-color">
                    ...
                    <div className="input-field col s12">
                      <center>
                        ...
                        {this.state.loading === true ? (
                          ...
                          <button
                            type="submit"
                            className="my-btn bg-color hoverable main-btn"
                          >
